namespace InforQui_17933.Migrations
{
    using Models;
    using System;
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<InforQui_17933.Models.ApplicationDbContext>
    {
        ...
        protected override void Seed(InforQui_17933.Models.ApplicationDbContext context)
        {
            //#######################################################################################
            ...
            var produtos = new List<Produtos> {
               ...
               new Produtos  {ProdutoID=12, Nome = "Cadinho ou Cápsula Porcelana",
               ...
               new Produtos  {ProdutoID=13, Nome = "Suporte Universal",
               ...
               new Produtos  {ProdutoID=16, Nome = "Estante para Tubos Ensaio",
            ...
            {
                new Compras {CompraID=1, Data=new DateTime(2016, 7, 9), UtilizadorFK="suares1985@inforqui.com"},
                new Compras {CompraID=2, Data=new DateTime(2015, 9, 9), UtilizadorFK="suares1985@inforqui.com"},
                new Compras {CompraID=3, Data=new DateTime(2017, 1, 7), UtilizadorFK="suares1985@inforqui.com"},
                new Compras {CompraID=4, Data=new DateTime(2012, 2, 27), UtilizadorFK="gusmao1979@inforqui.com"},
                new Compras {CompraID=5, Data=new DateTime(2011, 9, 17), UtilizadorFK="gusmao1979@inforqui.com"},
                new Compras {CompraID=6, Data=new DateTime(2013, 10, 20), UtilizadorFK="gusmao1979@inforqui.com"},
                new Compras {CompraID=7, Data=new DateTime(2016, 9, 16), UtilizadorFK="gusmao1979@inforqui.com"},
                new Compras {CompraID=8, Data=new DateTime(2014, 11, 19), UtilizadorFK="suares1985@inforqui.com"},
                new Compras {CompraID=9, Data=new DateTime(2012, 9, 23), UtilizadorFK="rositobelo@inforqui.com"},
                new Compras {CompraID=10, Data=new DateTime(2015, 5, 15), UtilizadorFK="rositobelo@inforqui.com"},
                new Compras {CompraID=11, Data=new DateTime(2014, 9, 8), UtilizadorFK="gusmao1979@inforqui.com"},
                new Compras {CompraID=12, Data=new DateTime(2013, 9, 17), UtilizadorFK="rositobelo@inforqui.com"},
                new Compras {CompraID=13, Data=new DateTime(2010, 2, 18), UtilizadorFK="gusmao1979@inforqui.com"},
                new Compras {CompraID=14, Data=new DateTime(2011, 8, 29), UtilizadorFK="gusmao1979@inforqui.com"},
                new Compras {CompraID=15, Data=new DateTime(2016, 9, 12), UtilizadorFK="gusmao1979@inforqui.com"},
                new Compras {CompraID=16, Data=new DateTime(2015, 12, 11), UtilizadorFK="rositobelo@inforqui.com"},
                new Compras {CompraID=17, Data=new DateTime(2012, 9, 10), UtilizadorFK="gusmao1979@inforqui.com"}
            };
            ...
            {
                new Compras_Produtos {Compras_ProdutoID=1, Quantidade=2, Preco=60.00, CompraFK=1, ProdutoFK=2},
